...
exports.getAds = async (req, res) => {
  try {
    ...
    } else { res.status(200).json(sortAd) }
  } catch (err) {
    serverError(res, err.message)
  }
}
...
exports.createAd = async (req, res) => {
  try {
    ...
    } else { res.status(201).json({ id: createdAd.id }) }
  } catch (err) {
    serverError(res, err.message)
  }
}
...
exports.updateAd = async (req, res) => {
  try {
    ...
    } else { res.status(200).json(updatedAd) }
  } catch (err) {
    serverError(res, err.message)
  }
}
...
exports.deleteAd = async (req, res) => {
  try {
    ...
    } else { res.status(200).json({ id: deletedAd.id }) }
  } catch (err) {
    serverError(res, err.message)
  }
}
