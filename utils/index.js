...
function adParser(countParam, query) {
  ...
  else if (countParam === 1 && isСontains(keys[0], 'description')) { return PARSED_OBJECTS.withDescription }
  else if (countParam === 1 && isСontains(keys[0], 'imgURLs')) { return PARSED_OBJECTS.withImgURLs }
}
